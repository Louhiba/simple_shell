...
/* toem_history.c */
char *get_history_file(inf_t *);
int write_history(inf_t *);
int read_history(inf_t *);
int build_history_list(inf_t *, char *buf, int linecount);
int renumber_history(inf_t *);

/* toem_lists.c */
list_t *add_node(list_t **, const char *, int);
list_t *add_node_e(list_t **, const char *, int);
